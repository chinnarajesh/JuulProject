...
import { OMNIDEF } from './updateAccountDetailsEnglish_def.js';
import tmpl from './updateAccountDetailsEnglish.html';
import tmpl_nds from './updateAccountDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class updateAccountDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
