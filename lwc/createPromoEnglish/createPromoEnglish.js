...
import { OMNIDEF } from './createPromoEnglish_def.js';
import tmpl from './createPromoEnglish.html';
import tmpl_nds from './createPromoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createPromoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
