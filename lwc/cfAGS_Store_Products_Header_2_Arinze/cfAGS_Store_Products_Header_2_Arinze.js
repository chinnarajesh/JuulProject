import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfAGS_Store_Products_Header_2_Arinze extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`AGS_Store_Products`,this._allMergeFields,this._regexPattern,"noparse");
