...
import { OMNIDEF } from './saveMission_ControlEnglish_def.js';
import tmpl from './saveMission_ControlEnglish.html';
import tmpl_nds from './saveMission_ControlEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class saveMission_ControlEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
