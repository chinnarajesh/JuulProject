import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfSsion_child_Store_Products_Planned_PTC extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`ssion_child_Store_Products_Planned_PTC`,this._allMergeFields,this._regexPattern,"noparse");
