...
import { OMNIDEF } from './clmCreatePromo_AccountPageEnglish_def.js';
import tmpl from './clmCreatePromo_AccountPageEnglish.html';
import tmpl_nds from './clmCreatePromo_AccountPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clmCreatePromo_AccountPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
