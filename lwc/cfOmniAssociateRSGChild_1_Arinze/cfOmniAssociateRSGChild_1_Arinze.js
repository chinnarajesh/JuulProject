import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfOmniAssociateRSGChild_1_Arinze extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfOmniAssociateRSGChild_1_Arinze';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_selectedRSGs`,this._allMergeFields,this._regexPattern,"noparse");
