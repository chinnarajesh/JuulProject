/*******************************************************************************************
 * @Name         ChatIndependentCopy
 * @Author       Pooja Gite <pooja.gite@juul.com>
 * @Date         09/20/2021
 * @Group        Customer Service
 * @Description  This is a LWC which starts live agent chat. Duplicated to ChatIndependent just to display differnt UI.
 *******************************************************************************************/
/* MODIFICATION LOG
* Version          Developer          Date               Description
*-------------------------------------------------------------------------------------------
*   1.0              Pooja         09/20/2020        Initial Creation
*******************************************************************************************/
...
export default class ChatIndependentCopy extends LightningElement {
