import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfAGS_Active_Misssions_1_Arinze extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfAGS_Active_Misssions_1_Arinze';
