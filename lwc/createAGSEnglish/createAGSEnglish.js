...
import { OMNIDEF } from './createAGSEnglish_def.js';
import tmpl from './createAGSEnglish.html';
import tmpl_nds from './createAGSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createAGSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
