import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfMission_child_Store_Product_Name extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`Mission_child_Store_Product_Name`,this._allMergeFields,this._regexPattern,"noparse");
