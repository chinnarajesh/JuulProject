import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfAGS_Active_Missions_Header extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfAGS_Active_Missions_Header';
