...
import { OMNIDEF } from './createContactEnglish_def.js';
import tmpl from './createContactEnglish.html';
import tmpl_nds from './createContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
