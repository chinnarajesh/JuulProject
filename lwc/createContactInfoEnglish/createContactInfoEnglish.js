...
import { OMNIDEF } from './createContactInfoEnglish_def.js';
import tmpl from './createContactInfoEnglish.html';
import tmpl_nds from './createContactInfoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createContactInfoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
