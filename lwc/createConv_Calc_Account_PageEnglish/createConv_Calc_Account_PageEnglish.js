...
import { OMNIDEF } from './createConv_Calc_Account_PageEnglish_def.js';
import tmpl from './createConv_Calc_Account_PageEnglish.html';
import tmpl_nds from './createConv_Calc_Account_PageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createConv_Calc_Account_PageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
