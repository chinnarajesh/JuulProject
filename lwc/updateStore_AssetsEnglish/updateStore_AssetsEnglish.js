...
import { OMNIDEF } from './updateStore_AssetsEnglish_def.js';
import tmpl from './updateStore_AssetsEnglish.html';
import tmpl_nds from './updateStore_AssetsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class updateStore_AssetsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
