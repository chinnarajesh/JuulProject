import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfAGS_Store_Assets_3_Arinze extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`AGS_Store_Assets`,this._allMergeFields,this._regexPattern,"noparse");
