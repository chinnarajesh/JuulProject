...
import { OMNIDEF } from './updateStore_ProductsEnglish_def.js';
import tmpl from './updateStore_ProductsEnglish.html';
import tmpl_nds from './updateStore_ProductsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class updateStore_ProductsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
