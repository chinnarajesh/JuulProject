...
import { OMNIDEF } from './launchMission_ControlEnglish_def.js';
import tmpl from './launchMission_ControlEnglish.html';
import tmpl_nds from './launchMission_ControlEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class launchMission_ControlEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
