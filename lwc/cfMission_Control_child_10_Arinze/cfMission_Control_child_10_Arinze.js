import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfMission_Control_child_10_Arinze extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfMission_Control_child_10_Arinze';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`Mission_Control_child`,this._allMergeFields,this._regexPattern,"noparse");
