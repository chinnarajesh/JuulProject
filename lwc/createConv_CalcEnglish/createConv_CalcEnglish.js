...
import { OMNIDEF } from './createConv_CalcEnglish_def.js';
import tmpl from './createConv_CalcEnglish.html';
import tmpl_nds from './createConv_CalcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createConv_CalcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
