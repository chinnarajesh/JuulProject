...
import { OMNIDEF } from './createJLPEnglish_def.js';
import tmpl from './createJLPEnglish.html';
import tmpl_nds from './createJLPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createJLPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
