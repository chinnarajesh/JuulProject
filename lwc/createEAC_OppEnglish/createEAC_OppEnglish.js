...
import { OMNIDEF } from './createEAC_OppEnglish_def.js';
import tmpl from './createEAC_OppEnglish.html';
import tmpl_nds from './createEAC_OppEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createEAC_OppEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
