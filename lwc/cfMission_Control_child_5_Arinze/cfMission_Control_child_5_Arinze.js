import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    ...
    import { load } from "vlocity_ins/newportLoader";
          ...
          export default class cfMission_Control_child_5_Arinze extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfMission_Control_child_5_Arinze';
