...
import { OMNIDEF } from './testActivateEnglish_def.js';
import tmpl from './testActivateEnglish.html';
import tmpl_nds from './testActivateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testActivateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
